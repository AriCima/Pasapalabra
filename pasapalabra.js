...
for (i=0; i<nroDeJugadores; i++) {
	...
	newPlayer.nombre = prompt('Ingrese el nombre del jugador Nro: ' + (i+1) + 'jugador nro ' + (i+1) + ' de '+ nroDeJugadores + ' jugadores');
	newPlayer.puntos = 0
...
for (i=0; i<=questions.length-1; i++){
    ...
    var letra = window.alert('Elige una letra', 'letra');

    for (y=0; y<jugadores.length; y++){

        var respuesta = window.prompt(jugadores[y].nombre + ' : ' + questions[i].question + ' tienes 5 segundos! ', 'respuesta');
